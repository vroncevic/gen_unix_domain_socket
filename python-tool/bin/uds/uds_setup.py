...
class UDSSetup(object):
    """
        Define class UDSSetup with attribute(s) and method(s).
        ...
        It defines:
            ...
            method:
                ...
                gen_uds_setup - Generate project skeleton
    """
    ...
    def __init__(self, verbose=False):
        """
            ...
            :exceptions: None
        """
        verbose_message(UDSSetup.VERBOSE, verbose, 'Initial setup')
        pass

    def gen_uds_setup(self, project_name, verbose=False):
        """

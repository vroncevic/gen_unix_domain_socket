...
project: str = 'gen_unix_domain_socket'
project_copyright: str = '2024, Vladimir Roncevic <elektron.ronca@gmail.com>'
author: str = 'Vladimir Roncevic <elektron.ronca@gmail.com>'
version: str = '1.0.4'
release: str = 'https://github.com/vroncevic/gen_unix_domain_socket/releases'
extensions: List[str] = [
...
htmlhelp_basename: str = 'gen_unix_domain_socketdoc'
latex_elements: Dict[Any, Any] = {}
latex_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_unix_domain_socket.tex', 'gen\\vhost Documentation',
    'Vladimir Roncevic \\textless{}elektron.ronca@gmail.com\\textgreater{}',
    'manual'
)]
man_pages: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_unix_domain_socket',
    'gen_unix_domain_socket Documentation',
    [author], 1
)]
texinfo_documents: List[Tuple[Any, ...]] = [(
    master_doc, 'gen_unix_domain_socket',
    'gen_unix_domain_socket Documentation', author,
    'gen_unix_domain_socket', 'One line description of project.',
    'Miscellaneous'
)]

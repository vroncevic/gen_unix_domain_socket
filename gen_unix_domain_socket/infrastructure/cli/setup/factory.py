...
from gen_unix_domain_socket.infrastructure.cli.setup.opt_validator import CLIBundleOptionsValidator
from gen_unix_domain_socket.infrastructure.cli.setup.bundle import CLIBundle
from gen_unix_domain_socket.infrastructure.cli.setup.keys import CLIBundleKeys
...
from gen_unix_domain_socket.infrastructure.command.icommand_definition import ICommandDefinition
from gen_unix_domain_socket.infrastructure.command.icommand_executor import ICommandExecutor
...
class CLIBundleFactory:
    ...
    def create_bundle(cls, options: CLIBundleOptions) -> CLIBundle:
        ...
        service_definition: ICommandDefinition = GenUnixDomainSocketCommandDefinition()
        service_executor: ICommandExecutor = GenUnixDomainSocketCommandExecutor(definition=service_definition)

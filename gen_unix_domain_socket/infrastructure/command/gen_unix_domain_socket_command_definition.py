...
Info
    Defines GenUnixDomainSocketCommandDefinition class.
'''
...
class GenUnixDomainSocketCommandDefinition:
    '''
        CLI subcommand metadata definition for unix_domain_socket project generation.
    ...
    def help_text(self) -> str:
        ...
        '''
        return 'Generate UnixDomainSocket project skeleton'
    ...
    def options(self) -> Sequence[OptionData]:
        ...
        return [
            OptionData(
                name="--name",
                help_text="unix_domain_socket project name",
                action=None,
                default="myapp",
                required=True,
                choices=None,

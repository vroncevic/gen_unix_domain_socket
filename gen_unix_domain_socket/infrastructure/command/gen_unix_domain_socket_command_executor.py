...
Info
    Defines GenUnixDomainSocketCommandExecutor class.
'''
...
class GenUnixDomainSocketCommandExecutor:
    '''
        Command executor strategy for generating unix_domain_socket project files.
        ...
        It defines:
            ...
            :methods:
                ...
                | __str__ - Returns the GenUnixDomainSocketCommandExecutor as string representation.
    '''
    ...
    def __str__(self) -> str:
        '''
            Returns the GenUnixDomainSocketCommandExecutor as string representation.

            :return: The GenUnixDomainSocketCommandExecutor as string representation.
        '''
        return to_str(self)

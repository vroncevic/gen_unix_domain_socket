...
class UnixDomainSocket(FileCheck, ProConfig, ProName):
    '''
        Defines class VHost with attribute(s) and method(s).
        Generates virtual host configuration module by template and parameters.
    ...
    _GEN_VERBOSE: str = 'GEN_UNIX_DOMAIN_SOCKET::PRO::UNIXDOMAINSOCKET'
    ...
    def gen_setup(
        ...
        verbose_message(
            verbose, [f'{self._GEN_VERBOSE.lower()} generate {module_name}']
        )
        status: bool = False

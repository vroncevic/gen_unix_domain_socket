...
Info
    A validator for the gen_unix_domain_socket bundle.
'''
...
class GenUnixDomainSocketBundleValidator:
    '''
        A validator for the gen_unix_domain_socket bundle.
        ...
        It defines:
            ...
            :methods:
                | validate - Validates the gen_unix_domain_socket bundle.
                | is_valid - Checks if the gen_unix_domain_socket bundle is valid.
    '''

    @classmethod
    def validate(cls, bundle: GenUnixDomainSocketBundle) -> None:
        '''
            Validates the gen_unix_domain_socket bundle.

            :param bundle: The gen_unix_domain_socket bundle to be validated.
            :exceptions:
        ...
        '''
        ctx: str = 'gen_unix_domain_socket_bundle_validator::validate(...)'
        msg_bundle_none: str = 'the gen_unix_domain_socket bundle must be provided'
        msg_bundle_istype: str = 'the gen_unix_domain_socket bundle must be an instance of GenUnixDomainSocketBundle'
        ...
        istype(bundle, GenUnixDomainSocketBundle, ctx, msg_bundle_istype)
    ...
    @classmethod
    def is_valid(cls, genunixdomainsocketbundle: GenUnixDomainSocketBundle) -> bool:
        '''
            Checks if the genunixdomainsocketbundle is valid.

            :param genunixdomainsocketbundle: The genunixdomainsocketbundle to be checked.
            :return: True if valid, False otherwise.
        '''
        try:
            cls.validate(genunixdomainsocketbundle)
            return True

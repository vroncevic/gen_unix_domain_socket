...
Info
    GenUnixDomainSocket bundle options for the gen_unix_domain_socket bundle.
'''
...
class GenUnixDomainSocketBundleOptions(TypedDict):
    '''
        GenUnixDomainSocket bundle options for the gen_unix_domain_socket bundle.
        ...
        It defines:
            ...
            :attributes:
                | info_file - The info file path for the gen_unix_domain_socket bundle.
    '''

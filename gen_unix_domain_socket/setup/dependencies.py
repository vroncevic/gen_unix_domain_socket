...
Info
    GenUnixDomainSocket bundle dependencies for the gen_unix_domain_socket bundle.
'''
...
class GenUnixDomainSocketBundleDependencies(TypedDict):
    '''
        GenUnixDomainSocket bundle dependencies for the gen_unix_domain_socket bundle.
        ...
        It defines:
            ...
            :attributes:
                | base - The base bundle with the base components for the gen_unix_domain_socket bundle.
                | service - The service orchestrating the gen_unix_domain_socket's execution for the gen_unix_domain_socket bundle.
                | subprocessor - The adapter executing the gen_unix_domain_socket's sub-processes for the gen_unix_domain_socket bundle.
                | cli - The command-line interface adapter for the gen_unix_domain_socket bundle.
    '''

...
Info
    Defines class GenUnixDomainSocket with attribute(s) and method(s).
...
class GenUnixDomainSocket(ATSCli):
    '''
        Defines class GenUnixDomainSocket with attribute(s) and method(s).
        ...
        It defines:
            ...
            :methods:
                | __init__ - Initials GenUnixDomainSocket constructor.
                | process - Processes and runs tool operation.
    '''

    _GEN_VERBOSE: str = 'GEN_UNIX_DOMAIN_SOCKET'
    _CONFIG: str = '/conf/gen_unix_domain_socket.cfg'
    _LOG: str = '/log/gen_unix_domain_socket.log'
    _LOGO: str = '/conf/gen_unix_domain_socket.logo'
    _OPS: List[str] = ['-n', '--name', '-v', '--verbose']

    def __init__(self, verbose: bool = False) -> None:
        '''
            Initials GenUnixDomainSocket constructor.
        ...
        gen_unix_domain_socket_property: Dict[str, str | bool] = {
        ...
        Splash(gen_unix_domain_socket_property, verbose)
        ...
        if self.is_operational():
            self.add_new_option(
                ...
                help='generate UDS skeleton (provide name)'
            )
            self.add_new_option(
        ...
        if self.is_operational():
            try:
                ...
                if exists(f'{getcwd()}/{str(getattr(args, "name"))}'):
                    ...
                    return status
                gen: UnixDomainSocket = UnixDomainSocket(
